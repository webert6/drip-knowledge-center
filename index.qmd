...
## What is DRIP?
If you're not exactly familiar with DRIP, allow me to explain. The DRIP Network was developed by Forex Shark and it's native coin is the DRIP token which can be purchased on the Binance Smart Chain. Purchasing the DRIP token is not as straightforward as buying Bitcoin, _yet_, so please see the Getting Started section for a step by step walkthrough. According to the whitepaper on the [website](www.drip.community):
...
[test reference](site/strategy/index.qmd)
